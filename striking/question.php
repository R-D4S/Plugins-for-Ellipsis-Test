 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_striking_question extends question_graded_by_strategy
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseenterananswer', 'qtype_striking');
    }
    ...
    public function grade_response(array $response) {
        $fraction = 0;
        $t = $response["answer"];
        foreach ($this->answers as $key => $ansid) {
            if (strpos($t,$ansid->answer) !== false) {
                $fraction += $ansid->fraction;
            }
        }
